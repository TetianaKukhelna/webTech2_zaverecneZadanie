...
if (isset($_GET['en'])){
    ...
    $popis_header = "Návod na pou¾ívanie stránky, popis vytvoreného API.";
    $popis = "Návod na pou¾ívanie stránky, opis vytvoreného rozhrania API.

    API, ktoré pou¾ívame, vyu¾íva CAS (Computer Aided System) a Octave na lep¹ie vykresµovanie grafov.
    Celý projekt sa spú¹»a pomocou nástroja Docker a má v sebe docker-compose.
    Na ukladanie a spracovanie údajov pou¾ívame lokálnu databázu MySQL, ktorú sme prepojili pomocou PHPMyAdmin.
    Ná¹ projekt spú¹»ame na adrese port:8000.
    Na stránke mô¾ete zada» svoje meno a Octave script, ktorý v pripade pruznosti nasimulujeme pomocou grafu a animacii.
    Po skonèení simulácie bude výstupom graf a animácia, ktorá bude slú¾i» na zobrazenie toho, aké hodnoty sme získali.

    Na stránke máte mo¾nos» stiahnu» si protokoly vo formáte CSV a posla» mi ich e-mailom. V súbore získate èas a dátum, kedy boli údaje vygenerované,
    èi bol príkaz vykonaný správne a v prípade neúspe¹ného príkazu získate informácie o chybe.

    Máte mo¾nos» stiahnu» si tento návod vo formáte PDF.
    Ni¾¹ie si mô¾ete vybra» jazyk.";
}
